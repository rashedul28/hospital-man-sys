...
function validateform()
{
    ...
    {
        document.getElementById("Username_message").innerHTML="Atleast 3 character required";
        return false;
    }
    else
    {
    ...
    {
        document.getElementById("message_fname").innerHTML="Atleast 3 alphabet required";
        return false;
    }
    else
    {
    ...
    {
        document.getElementById("message_lname").innerHTML="Atleast 3 alphabet required";
        return false;
    }
    else
    {
   ...
   document.getElementById("message_gender").innerHTML ="Radio must be filled out";
    ...
    {
        document.getElementById("pass_message").innerHTML="Atleast 6 character required";
        return false;
    }
    else
    {
